...
import heroBg from "@/assets/hero-cibubur.jpg";
    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 py-32 lg:py-40">
        <div className="max-w-3xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary-foreground/10 backdrop-blur-sm border border-primary-foreground/20 text-primary-foreground text-sm font-medium mb-6 animate-fade-up">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-primary-foreground leading-tight mb-6 animate-fade-up" style={{ animationDelay: "0.1s" }}>
            ...
            <span className="text-accent">Kelurahan Cibubur</span>
          </h1>
        ...
        {/* Stats */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-16 max-w-4xl mx-auto animate-fade-up" style={{ animationDelay: "0.4s" }}>
          <div className="glass-card rounded-2xl p-6 text-center">
            <Users className="w-8 h-8 text-primary mx-auto mb-3" />
            <div className="text-3xl font-bold text-foreground mb-1">45,230</div>
          ...
          <div className="glass-card rounded-2xl p-6 text-center">
            ...
            <div className="text-muted-foreground text-sm">Layanan Bulan Ini</div>
          </div>
          <div className="glass-card rounded-2xl p-6 text-center">
